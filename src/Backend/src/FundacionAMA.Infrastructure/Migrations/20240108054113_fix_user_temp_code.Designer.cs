...
namespace FundacionAMA.Infrastructure.Migrations
{
    ...
    [Migration("20240108054113_fix_user_temp_code")]
    partial class fix_user_temp_code
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FundacionAMA.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = false,
                            CreatedAt = new DateTime(2024, 1, 8, 0, 41, 13, 394, DateTimeKind.Local).AddTicks(4819),
                            CreatedBy = 0,
                            ...
                            Status = "A",
                            TempCode = "94632a0d-9802-46d9-a775-f070510596cd"
                        });
                });
