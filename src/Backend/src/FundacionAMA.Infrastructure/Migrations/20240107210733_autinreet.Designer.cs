...
namespace FundacionAMA.Infrastructure.Migrations
{
    ...
    [Migration("20240107210733_autinreet")]
    partial class autinreet
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FundacionAMA.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = false,
                            CreatedAt = new DateTime(2024, 1, 7, 16, 7, 33, 640, DateTimeKind.Local).AddTicks(7057),
                            CreatedBy = 0,
                            ...
                            Status = "A",
                            TempCode = "50f352be-5172-438b-857d-f51c7895f67c"
                        });
                });
