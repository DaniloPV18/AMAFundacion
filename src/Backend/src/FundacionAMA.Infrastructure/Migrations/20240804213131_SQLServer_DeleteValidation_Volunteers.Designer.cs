...
namespace FundacionAMA.Infrastructure.Migrations
{
    ...
    [Migration("20240804213131_SQLServer_DeleteValidation_Volunteers")]
    partial class SQLServer_DeleteValidation_Volunteers
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FundacionAMA.Domain.Entities.ActivityType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreatedAt = new DateTime(2024, 8, 4, 16, 31, 31, 684, DateTimeKind.Local).AddTicks(2166),
                            CreatedBy = 0,
            ...
            modelBuilder.Entity("FundacionAMA.Domain.Entities.DonationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreatedAt = new DateTime(2024, 8, 4, 16, 31, 31, 688, DateTimeKind.Local).AddTicks(8673),
                            CreatedBy = 0,
                            Name = "viveres",
                            Status = "A"
                        },
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreatedAt = new DateTime(2024, 8, 4, 16, 31, 31, 688, DateTimeKind.Local).AddTicks(8689),
                            CreatedBy = 0,
                            Name = "medicina",
                            Status = "A"
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreatedAt = new DateTime(2024, 8, 4, 16, 31, 31, 688, DateTimeKind.Local).AddTicks(8690),
                            CreatedBy = 0,
                            Name = "vestimenta",
                            Status = "A"
                        },
                        new
                        {
                            Id = 4,
                            Active = true,
                            CreatedAt = new DateTime(2024, 8, 4, 16, 31, 31, 688, DateTimeKind.Local).AddTicks(8691),
                            CreatedBy = 0,
                            Name = "monetario",
                            Status = "A"
                        },
                        new
                        {
                            Id = 5,
                            Active = true,
                            CreatedAt = new DateTime(2024, 8, 4, 16, 31, 31, 688, DateTimeKind.Local).AddTicks(8692),
                            CreatedBy = 0,
                            Name = "tecnologia",
                            Status = "A"
                        },
                        new
                        {
                            Id = 6,
                            Active = true,
                            CreatedAt = new DateTime(2024, 8, 4, 16, 31, 31, 688, DateTimeKind.Local).AddTicks(8694),
                            CreatedBy = 0,
                            Name = "suministros",
                            Status = "A"
                        },
                        new
                        {
                            Id = 7,
                            Active = true,
                            CreatedAt = new DateTime(2024, 8, 4, 16, 31, 31, 688, DateTimeKind.Local).AddTicks(8695),
                            CreatedBy = 0,
                            Name = "varios",
                            Status = "A"
                        });
            ...
            modelBuilder.Entity("FundacionAMA.Domain.Entities.IdentificationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Code = "CC",
                            CreatedAt = new DateTime(2024, 8, 4, 16, 31, 31, 689, DateTimeKind.Local).AddTicks(7062),
                            CreatedBy = 0,
            ...
            modelBuilder.Entity("FundacionAMA.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = false,
                            CreatedAt = new DateTime(2024, 8, 4, 16, 31, 31, 691, DateTimeKind.Local).AddTicks(2740),
                            CreatedBy = 0,
                            ...
                            Status = "A",
                            TempCode = "52a9e02e-cc7e-41a0-8909-9887beef59aa"
                        });
                });
