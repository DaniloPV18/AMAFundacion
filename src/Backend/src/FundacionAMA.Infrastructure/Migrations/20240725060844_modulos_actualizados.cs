...
{
    /// <inheritdoc />
    public partial class modulos_actualizados : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, true, null, new DateTime(2024, 7, 25, 1, 8, 44, 192, DateTimeKind.Local).AddTicks(4221), 0, "PRUEBA DE ACTIVIDAD", "A", null, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, null, new DateTime(2024, 7, 25, 1, 8, 44, 196, DateTimeKind.Local).AddTicks(5911), 0, "viveres", "A", null, null },
                    { 2, true, null, new DateTime(2024, 7, 25, 1, 8, 44, 196, DateTimeKind.Local).AddTicks(5922), 0, "medicina", "A", null, null },
                    { 3, true, null, new DateTime(2024, 7, 25, 1, 8, 44, 196, DateTimeKind.Local).AddTicks(5924), 0, "vestimenta", "A", null, null },
                    { 4, true, null, new DateTime(2024, 7, 25, 1, 8, 44, 196, DateTimeKind.Local).AddTicks(5925), 0, "monetario", "A", null, null },
                    { 5, true, null, new DateTime(2024, 7, 25, 1, 8, 44, 196, DateTimeKind.Local).AddTicks(5927), 0, "tecnologia", "A", null, null },
                    { 6, true, null, new DateTime(2024, 7, 25, 1, 8, 44, 196, DateTimeKind.Local).AddTicks(5928), 0, "suministros", "A", null, null },
                    { 7, true, null, new DateTime(2024, 7, 25, 1, 8, 44, 196, DateTimeKind.Local).AddTicks(5929), 0, "varios", "A", null, null }
                });

            migrationBuilder.InsertData(
                table: "IdentificationType",
                columns: new[] { "Id", "Active", "Code", "CompanyId", "CreatedAt", "CreatedBy", "Description", "Status", "UpdatedAt", "UpdatedBy" },
                values: new object[] { (short)1, true, "CC", null, new DateTime(2024, 7, 25, 1, 8, 44, 197, DateTimeKind.Local).AddTicks(3089), 0, "Cédula de ciudadanía", "A", null, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, false, new DateTime(2024, 7, 25, 1, 8, 44, 198, DateTimeKind.Local).AddTicks(6398), 0, "system@email.com", "9999999999999", "System", "hx7w741jRKptsZJYyBjLQfz4agjKMGEJoK0kVwbbthI=", "UhfyKxRscxd78Aoj0WOzigBOnis+fUNtHEc8kfQkOCg=", "A", "75dfba88-fd1a-4b54-8729-c1de86865548", null, null, null });
