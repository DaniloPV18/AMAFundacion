...
namespace FundacionAMA.Infrastructure.Migrations
{
    ...
    [Migration("20240716034841_correccionbrigada")]
    partial class correccionbrigada
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FundacionAMA.Domain.Entities.ActivityType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreatedAt = new DateTime(2024, 7, 15, 22, 48, 39, 981, DateTimeKind.Local).AddTicks(4938),
                            CreatedBy = 0,
            ...
            modelBuilder.Entity("FundacionAMA.Domain.Entities.DonationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreatedAt = new DateTime(2024, 7, 15, 22, 48, 40, 25, DateTimeKind.Local).AddTicks(8354),
                            CreatedBy = 0,
                            Name = "viveres",
                            Status = "A"
                        },
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreatedAt = new DateTime(2024, 7, 15, 22, 48, 40, 25, DateTimeKind.Local).AddTicks(8393),
                            CreatedBy = 0,
                            Name = "medicina",
                            Status = "A"
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreatedAt = new DateTime(2024, 7, 15, 22, 48, 40, 25, DateTimeKind.Local).AddTicks(8396),
                            CreatedBy = 0,
                            Name = "vestimenta",
                            Status = "A"
                        },
                        new
                        {
                            Id = 4,
                            Active = true,
                            CreatedAt = new DateTime(2024, 7, 15, 22, 48, 40, 25, DateTimeKind.Local).AddTicks(8399),
                            CreatedBy = 0,
                            Name = "monetario",
                            Status = "A"
                        },
                        new
                        {
                            Id = 5,
                            Active = true,
                            CreatedAt = new DateTime(2024, 7, 15, 22, 48, 40, 25, DateTimeKind.Local).AddTicks(8402),
                            CreatedBy = 0,
                            Name = "tecnologia",
                            Status = "A"
                        },
                        new
                        {
                            Id = 6,
                            Active = true,
                            CreatedAt = new DateTime(2024, 7, 15, 22, 48, 40, 25, DateTimeKind.Local).AddTicks(8405),
                            CreatedBy = 0,
                            Name = "suministros",
                            Status = "A"
                        },
                        new
                        {
                            Id = 7,
                            Active = true,
                            CreatedAt = new DateTime(2024, 7, 15, 22, 48, 40, 25, DateTimeKind.Local).AddTicks(8409),
                            CreatedBy = 0,
                            Name = "varios",
                            Status = "A"
                        });
            ...
            modelBuilder.Entity("FundacionAMA.Domain.Entities.IdentificationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Code = "CC",
                            CreatedAt = new DateTime(2024, 7, 15, 22, 48, 40, 30, DateTimeKind.Local).AddTicks(4827),
                            CreatedBy = 0,
            ...
            modelBuilder.Entity("FundacionAMA.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = false,
                            CreatedAt = new DateTime(2024, 7, 15, 22, 48, 40, 54, DateTimeKind.Local).AddTicks(4913),
                            CreatedBy = 0,
                            ...
                            Status = "A",
                            TempCode = "de5b5624-165f-4fcf-9c77-fe46c7792962"
                        });
                });
