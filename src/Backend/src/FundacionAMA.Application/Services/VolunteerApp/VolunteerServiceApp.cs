...
namespace FundacionAMA.Application.Services.VolunteerApp
{
    internal class VolunteerServiceApp : IVolunteerServiceApp
    {
        ...
        // aqui  modifico yo
        public Task<IOperationResult<VolunteerDto>> GetByIdentification(string identification)
        {
            return _volunteerService.GetByIdentification(identification);
        }

        public Task<IOperationResult<int>> GetCount()
        {
            return _volunteerService.GetCount();
        }
